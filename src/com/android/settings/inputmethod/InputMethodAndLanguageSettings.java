...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        PreferenceCategory pointerSettingsCategory =
            (PreferenceCategory) findPreference("pointer_settings_category");
        mInputMethodExts = new InputMethodExts(activity, mShowsOnlyFullImeAndKeyboardList,
                voiceCategory, pointerSettingsCategory);
    ...
    public void onResume() {
        ...
        /// M: Input method extends features
        mInputMethodExts.resumeExtendsItems();
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        } else { /// M: Input method extends features
            mInputMethodExts.onClickExtendsItems(preference.getKey());
        }
    ...
    private void updateHardKeyboards() {
		...
		//Gionee <GN_FRAMEWORK_FP> <silead_fp> <2017-02-06> add begin
                String deviceName = device.getName();
                if (deviceName != null && deviceName.contains("silead")) {
                    continue;							                   
		}
		//Gionee <GN_FRAMEWORK_FP> <silead_fp> <2017-02-06> add end
