...
public class ApnEditor extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        /// M: for plug-in @{
        mApnExt = UtilsExt.getApnSettingsPlugin(getContext());
        /// @}
        ...
        if (action.equals(Intent.ACTION_EDIT)) {
            ...
            if (mFirstTime || icicle.getInt(SAVED_POS) == 0) {
                ...
                /// M: for plug-in
                mUri = mApnExt.getUriFromIntent(mUri, getContext(), intent);
            } else {
                Log.d(TAG, "saved pos is " + icicle.getInt(SAVED_POS));
    ...
    private void fillUi() {
        Log.d(TAG, "fillUi... mFirstTime = " + mFirstTime);
        /// M: @{
        ...
        /// M: Don't use first time to avoid clearing apn parameters when go back
        ///    this activity after it has been stoped.
        //if (mFirstTime) {
        //   mFirstTime = false;
        ...
        String authValue = mAuthType.getValue();
        if (authValue != null) {
    ...
    */
    ...
    private void updateScreenEnableState() {
        ...
        mApnExt.updateFieldsStatus(mSubId, mSourceType, getPreferenceScreen());
