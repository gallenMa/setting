...
public class TetherSettings extends RestrictedSettingsFragment
    ...
    // must set to "true" for lauch setting case after startup
    private boolean mUsbUnTetherDone = true;
    // must set to "true" for lauch setting case after startup
    private boolean mUsbTetherDone = true;
    // must set to "false" for lauch setting case after startup
    ...
    private class TetherChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context content, Intent intent) {
            ...
            if (action.equals(ConnectivityManager.ACTION_TETHER_STATE_CHANGED)) {
                ...
                /// M: print log
                Log.d(TAG, "mUsbUnTetherDone? :" + mUsbUnTetherDone + " , mUsbTetherDonel? :" +
                ...
                Log.d(TAG, "TetherChangeReceiver - ACTION_USB_STATE mUsbConnected: "
                    + mUsbConnected +
    ...
    private void updateUsbState(String[] available, String[] tethered,
        ...
        if (usbTethered) {
            ...
            Log.d(TAG, "updateUsbState - usbTethered - mUsbTetherCheckEnable: "
            ...
            if (mUsbTetherCheckEnable) {
                Log.d(TAG, "updateUsbState - mUsbTetherCheckEnable, " +
            ...
            Log.d(TAG, "updateUsbState - usbAvailable - mUsbConfigured:  " + mUsbConfigured +
            ...
            Log.d(TAG, "updateUsbState- usbAvailable- mUsbHwDisconnected:" + mUsbHwDisconnected);
        }
    }
    ...
    private boolean updateStateExt(String[] available, String[] tethered,
            String[] errored) {
        Log.d(TAG, "=======> updateState - mUsbConnected: " + mUsbConnected +
                ", mUsbConfigured:  " + mUsbConfigured + ", mUsbHwDisconnected: " +
